const missions = [
  {
    ...
    mission_name: 'ABS', mission_id: '2CF444A', manufacturers: ['Boeing'], payload_ids: ['ABS-3A', 'ABS-3B'], wikipedia: 'https://en.wikipedia.org/wiki/ABS_(satellite_operator)', website: 'http://www.absatellite.com/', twitter: null, description: 'ABS, formerly Asia Broadcast Satellite, is a global satellite operator based in Hong Kong and officially incorporated in Bermuda. Its services include direct-to-home and satellite-to-cable TV distribution, cellular services, and internet services. Operating 6 communication satellites, the satellite fleet currently covers 93% of the world’s population including the Americas, Africa, Asia Pacific, Europe, the Middle East, Russia and Commonwealth of Independent States.',
  }, {
...
export default function returnMissions() {
  return missions;
}
export function returnDragons() {
  return dragons;
}
